...
(() => {
    ...
    const ownedGames = [
        ...
        {
                "title": "ポケットモンスター ブリリアントダイヤモンド・シャイニングパール",
                "aliases": [
                        "ポケモンBDSP",
                        "BDSP"
                ],
  ...
  <div id="gameLibraryList" class="game-library-grid" aria-live="polite"></div>
    ...
    function renderGameLibrary() {
        ...
        let filtered=ownedGames.filter(game=>{
            const haystack=normalizeText([game.title,...(game.aliases||[]),...game.libraries,game.type,game.status].join(" "));
